...
Private Sub cmdOK_Click()
    ...
    End If
    If Trim(cmbFileNames.Text) <> "" Then
        WriteGenCFG2DefCFG cmbFileNames.Text
        cmdSelect_Click
    End If
    Unload Me
...
Private Sub cmdSelect_Click()
    If Trim(cmbFileNames.Text) <> "" Then
        ...
        WriteGenCFG2DefCFG frmMain.gGrammarFile
        ...
        'Speech2User frmMain.gGrammarFile & " is Selected", 4
    End If
End Sub
...
'Populate the combobox with the file names
